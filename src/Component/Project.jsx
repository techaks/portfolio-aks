    ...
    <div className="skill text-white ml-4 md:ml-24 mt-12 ">
      ...
      <div className="mt-12 w-full md:w-2/3 mx-auto flex flex-wrap md:flex-nowrap  justify-center gap-14 pb-10 p-5 md:p-5">
        {projects.map((project, index) => (
          <div
            className=" w-full md:w-2/3   bg-[#0d0d1f] rounded-lg p-5 border border-transparent 
          ...
          >
            ...
            <p className="m-2 text-center font-bold text-sky-400">
              {project.title}
            </p>
            <p className="font-semibold">{project.description}</p>
           

            <div  onClick={() => window.open(project.url)} className="w-fit m-2 mx-auto mb-4  ">
              <Button2 />
            </div>
