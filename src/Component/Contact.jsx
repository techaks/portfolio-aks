      ...
      <div className="mt-10 bg-[#0d081f] max-w-md  font-semibold text-xl rounded-xl px-5 py-3 pb-8 mx-auto ">
        <form ref={form} onSubmit={connectMe}>
          ...
          <input
            ...
            required
            className="outline-none w-full px-3 py-1 border-2 rounded-xl  border-[#00012C]  bg-[#131025]  focus:border-purple-500 my-3 "
          />
          ...
          <textarea
            ...
            className=" resize-none border-2 rounded-xl  border-[#00012C] bg-[#131025] focus:border-purple-500 my-3 px-3 py-1 w-full focus:outline-none"
          ></textarea>
          <div className="  ">
            {loader ? (
              <Loader />
              ...
              <button
                type="submit"
                className="text-center w-full bg-gradient-to-r from-purple-600 to-pink-500 py-2 rounded-md cursor-pointer hover:opacity-80"
              >
                SEND
              </button>
            )}
